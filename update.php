    ...
    <div class="container">
        ...
        <div class="form mt-5">
            <form method="post" enctype="multipart/form-data">
                <input type="hidden" name="number" value="<?php echo htmlspecialchars($invoice['number'], ENT_QUOTES, 'UTF-8'); ?>" />
                <input type="hidden" name="amount" value="<?php echo htmlspecialchars($invoice['amount'], ENT_QUOTES, 'UTF-8'); ?>" />
                <div class="mb-3">
                    <label for="client" class="form-label fw-bold text-primary">Client Name</label>
                    <input type="text" class="form-control" name="client" placeholder="Client Name" value="<?php echo htmlspecialchars($invoice['client'], ENT_QUOTES, 'UTF-8'); ?>">
